...
const BAND_PROGRAMS=[
 {name:'Open ensemble',transpose:0,space:.3,echo:.12,pattern:'flow'},
 {name:'Three-beat sway',transpose:0,space:.4,echo:.2,pattern:'sway'},
 {name:'Offbeat mechanisms',transpose:-12,space:.14,echo:.08,pattern:'skip'},
 {name:'Room to breathe',transpose:-12,space:.48,echo:.18,pattern:'sparse'},
 {name:'Double time',transpose:0,space:.09,echo:.24,pattern:'double'}
];
